...
### Proposed Direction
Our long-term vision is a cylindrical autonomous trap approximately the height of vineyard trellises and about two feet in diameter.
...
- Restrictions on organic or food-safe attractants?
...
### Purpose
The prototype was designed to evaluate whether a rotating mechanical system can effectively attract, guide, and capture spotted lanternflies while preserving grapevine integrity.

---

### What Was Tested
We evaluated the performance of key subsystems related to:

- Guidance of insects toward the center of the device
- Capture and containment mechanisms
- Stability and consistency of rotational motion

Testing focused on how mechanical design and rotation influence insect behavior and system reliability.

---

### Outcome Summary
The prototype successfully demonstrated that a rotating system can guide and capture spotted lanternflies under controlled conditions. Performance improvements were observed through iterative adjustments such as alignment corrections and friction reduction, confirming that the design responds well to refinement.

---

### Key Insights
- Rotational motion can control insect movement without requiring direct force
- Small mechanical adjustments significantly improve system performance
- The concept is mechanically feasible at prototype scale
...
- Attractant effectiveness still under evaluation

---

### Next Steps
- Scale the design to vineyard size
- Conduct field testing
- Improve attractant effectiveness
- Refine rotational stability
...
- Guided movement of insects toward a central region
- Transfer into a containment chamber

The exhibit showed how mechanical motion can influence insect behavior in a controlled and non-destructive way.

---

### Client-Focused Results
From a client perspective, the prototype demonstrated:

- Feasibility of the concept as a working system
- Effective guidance and capture behavior
- Potential for scaling to vineyard applications

---

### Engineering Validation
The prototype supports key design assumptions:
...
- The system shows potential to reduce reliance on pesticides
- Further development is justified based on prototype performance
